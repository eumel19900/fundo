...
namespace fundo
{
    ...
    public partial class App : Application
    {
        ...
        {
            if (_isNotifyIconCreated || MainWindowInstance == null)
            {
                return;
            }

            _mainWindowHandle = WindowNative.GetWindowHandle(MainWindowInstance);
            ...
            if (_previousWindowProc == IntPtr.Zero)
            {
                ...
                _previousWindowProc = SetWindowLongPtr(_mainWindowHandle, GwlWndProc, newWindowProc);
            }

            string iconPath = System.IO.Path.Combine(AppContext.BaseDirectory, "fundo.ico");
        ...
        private void EnsureMainWindowIsOpen()
        {
            ...
            if (MainWindowInstance != null)
            {
                MainWindowInstance.Closed += (_, _) => RemoveNotifyIcon();
            }
            _window.Activate();
        }
        ...
        private static void HideMainWindowToTray(IntPtr windowHandle)
        {
        ...
        private void ShowNotifyIconContextMenu()
        {
            ...
            try
            {
                ...
                if (GetCursorPos(out POINT point))
                {
                    ...
                    TrackPopupMenuEx(menu, TpmLeftAlign | TpmBottomAlign | TpmRightButton, point.X, point.Y, _mainWindowHandle, IntPtr.Zero);
                    PostMessage(_mainWindowHandle, WmNull, IntPtr.Zero, IntPtr.Zero);
                }
            }
            finally
            {
